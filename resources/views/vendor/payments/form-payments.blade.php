...
@section('title', 'Teste Pagamento Cartão de Crédito')
...
@section('content_header')
    <h1>Sistema de Pagamento de Cartão de Crédito (Ambiente de Testes)</h1>
@stop
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('teste/createPayment/pagamentos/cred_card') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <i id="ico-card" class="fa fa-credit-card fa-2x" ></i>
                            <div class="col-md-6">
