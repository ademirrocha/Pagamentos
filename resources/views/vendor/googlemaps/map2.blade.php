...
<html>
  <head>
    ...
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?libraries=places,geometry&key=AIzaSyD_4DuifX8CnPbWbQnH4SSNUlrisXyYGPM">
    </script>
    <script src="/_static/js/jquery-bundle.js"></script>
    <script>
    // Replace with your own API key
var API_KEY = 'AIzaSyD_4DuifX8CnPbWbQnH4SSNUlrisXyYGPM';
